            ...
            <section id="contact" className="contact">
                <div className="container text-left">
                    ...
                    <div className="describe mt-12">
                        ...
                        <h2 className="font-normal text-[21px] mt-5">Interested in my blog? Check it out <a href="https://gustavsiljuconoks.github.io/blog/" target='_blank' className='underline'>here</a>.</h2>
                    </div>
                </div>
            </section>
        </>
